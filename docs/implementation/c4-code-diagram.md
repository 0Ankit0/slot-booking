...
---
## Implementation-Ready C4 Code Diagram
...
### Mermaid code-module interaction map
```mermaid
flowchart LR
  Controller --> AppService
  AppService --> AllocationDomain
  AppService --> ConflictDomain
  AppService --> PaymentAdapter
  AppService --> CancellationDomain
  AppService --> RepoPorts
  RepoPorts --> PostgresAdapter
