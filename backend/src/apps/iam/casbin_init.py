...
async def setup_default_roles_and_permissions(session):
    ...
    permissions = [
        ...
        Permission(resource="providers", action="read", description="View providers"),
        Permission(resource="providers", action="write", description="Create/edit providers"),
        Permission(resource="providers", action="delete", description="Delete providers"),
        Permission(resource="resources", action="read", description="View resources"),
        Permission(resource="resources", action="write", description="Create/edit resources"),
        Permission(resource="resources", action="delete", description="Delete resources"),
        Permission(resource="availability", action="read", description="View availability"),
        Permission(resource="availability", action="write", description="Manage availability"),
        Permission(resource="bookings", action="read", description="View bookings"),
        Permission(resource="bookings", action="write", description="Create/update bookings"),
        Permission(resource="bookings", action="delete", description="Cancel/delete bookings"),
        Permission(resource="payouts", action="read", description="View payouts"),
        Permission(resource="payouts", action="write", description="Manage payouts"),
        Permission(resource="reviews", action="read", description="View reviews"),
        Permission(resource="reviews", action="write", description="Moderate reviews"),
        Permission(resource="disputes", action="read", description="View disputes"),
        Permission(resource="disputes", action="write", description="Resolve disputes"),
        Permission(resource="analytics", action="read", description="View analytics"),
        Permission(resource="system_policy", action="write", description="Manage system policy"),
    ]
